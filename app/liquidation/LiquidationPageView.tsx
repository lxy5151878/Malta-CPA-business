...
export default function LiquidationPageView({ lang }: { lang: Lang }) {
  const copy = getSiteCopy(lang);
  const p = copy.pages.liquidation;
  ...
  return (
    <main className="page-wrapper">
      ...
      <section className="container pb-5 mb-md-3 mb-lg-4 mb-xxl-5">
        <div className="row align-items-center g-4 g-lg-5">
          <div className="col-lg-6">
            <div className="card border-0 bg-secondary rounded-5 h-100">
              <div className="card-body p-4 p-lg-5">
                <h2 className="h1 mb-3">{p.process.title}</h2>
                <p className="text-body-secondary mb-4">{p.process.body}</p>

                <h3 className="h5 mb-3">{p.process.listTitle}</h3>
                <ul className="list-unstyled mb-0">
                  {p.process.items.map((n) => (
          ...
          <div className="col-lg-6">
            <div className="ps-lg-2">
              <h2 className="h1 mb-3">{p.transition.title}</h2>
              <p className="fs-lg text-body-secondary mb-4">{p.transition.body}</p>

              <div className="row row-cols-1 row-cols-sm-2 g-3">
                {p.benefits.items.slice(0, 6).map((b) => (
      ...
      {/* <section className="container pb-5 mb-md-3 mb-lg-4 mb-xxl-5">
        <div className="row align-items-end mb-4">
          <div className="col-lg-7">
            <h2 className="h1 mb-2">{p.related.title}</h2>
            <p className="text-body-secondary mb-0">{p.related.subtitle}</p>
          </div>
        </div>

        <div className="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
          {p.related.items.map((s) => (
            <div className="col" key={s.title}>
              <a className="card h-100 border-0 bg-secondary rounded-5 text-decoration-none" href={s.href}>
                <div className="card-body p-4 p-lg-5">
                  <div className="d-flex align-items-start gap-3">
                    <div className="btn btn-icon btn-lg btn-outline-primary rounded-circle pe-none flex-shrink-0">
                      <i className={s.icon} />
                ...
                <div className="card-footer border-0 bg-transparent px-4 px-lg-5 pb-4 pb-lg-5 pt-0">
                  <span className="btn btn-icon btn-lg btn-outline-primary rounded-circle" aria-label="Learn more">
      ...
      <section className="container pb-5 mb-lg-4 mb-xxl-5">
        <div className="row">
          ...
          <div className="col-lg-7">
            <div className="accordion" id="liquidationFaq">
