  ...
  return (
    <main className="page-wrapper">
      ...
      <section className="position-relative overflow-hidden pt-5">
        <div className="container position-relative z-2 pt-4 pt-sm-5 mt-2 mt-sm-0 mt-md-2 mt-lg-3 mt-xl-4 mt-xxl-5">
          <div className="row justify-content-center py-4">
            <div className="col-lg-11 col-xl-10 text-center pb-2 pb-sm-3 mb-lg-2 mb-xl-3">
              <h1 className="display-2 fw-normal mb-0">
                <span className="fw-bold">Acquiring Malta Passport</span> by Fund Investment
              </h1>
            </div>
          </div>
          <div
          ...
          >
            <div
              ...
              data-depth="-0.05"
              style={{
                transform: "translate3d(4.9px, -0.7px, 0px)",
                transformStyle: "preserve-3d",
                backfaceVisibility: "hidden",
                position: "relative",
                display: "block",
            ...
            >
              <img className="d-dark-mode-none" src="assets/img/about/product/hero/01-light.png" alt="Layer" />
              <img className="d-none d-dark-mode-block" src="assets/img/about/product/hero/01-dark.png" alt="Layer" />
            </div>
            ...
            <div
              ...
              data-depth="0.1"
              style={{
                transform: "translate3d(-9.9px, 1.5px, 0px)",
                transformStyle: "preserve-3d",
                backfaceVisibility: "hidden",
                position: "absolute",
                display: "block",
            ...
            >
              <img className="d-dark-mode-none" src="assets/img/about/product/hero/02-light.png" alt="Layer" />
              <img className="d-none d-dark-mode-block" src="assets/img/about/product/hero/02-dark.png" alt="Layer" />
            </div>
            ...
            <div
              ...
              data-depth="0.2"
              style={{
                transform: "translate3d(-19.8px, 3px, 0px)",
                transformStyle: "preserve-3d",
                backfaceVisibility: "hidden",
                position: "absolute",
                display: "block",
            ...
            >
              <img className="d-dark-mode-none" src="assets/img/about/product/hero/03-light.png" alt="Layer" />
              <img className="d-none d-dark-mode-block" src="assets/img/about/product/hero/03-dark.png" alt="Layer" />
            </div>
            ...
            >
              <img className="d-dark-mode-none" src="assets/img/about/product/hero/04-light.png" alt="Layer" />
              <img className="d-none d-dark-mode-block" src="assets/img/about/product/hero/04-dark.png" alt="Layer" />
            </div>
            ...
            <div
              ...
              data-depth="-0.25"
              style={{
                transform: "translate3d(24.7px, -3.7px, 0px)",
                transformStyle: "preserve-3d",
                backfaceVisibility: "hidden",
                position: "absolute",
                display: "block",
            ...
            >
              <img className="d-dark-mode-none" src="assets/img/about/product/hero/05-light.png" alt="Layer" />
              <img className="d-none d-dark-mode-block" src="assets/img/about/product/hero/05-dark.png" alt="Layer" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container pt-5 mt-xl-3 mt-xxl-4">
        <h2 className="h4 text-center pb-3 pb-md-4 mb-lg-4">Join 1000+ companies whos reached Around</h2>
        <div className="row row-cols-3 row-cols-sm-4 row-cols-lg-5 row-cols-xl-6 justify-content-center align-items-center g-4">
          {[
            ["foster", 145, "Foster"],
            ["klinos", 140, "Klinos"],
            ["champion", 160, "Champion"],
            ["airbnb", 130, "Airbnb"],
            ["starcraft", 160, "Starcraft"],
            ["alpine", 150, "Alpine"],
          ].map(([name, w, label]) => (
            <div className="col text-center" key={String(name)}>
              <a className="swap-image my-1 my-sm-2" href="#">
                <img className="swap-to" src={`assets/img/landing/saas-1/brands/${name}-color.svg`} width={Number(w)} alt={String(label)} />
                <div className="swap-from">
                  <img
                    className="d-dark-mode-none"
                    src={`assets/img/landing/saas-1/brands/${name}-gray.svg`}
                    width={Number(w)}
                    alt={String(label)}
                  />
                  <img
                    className="d-none d-dark-mode-block"
                    src={`assets/img/landing/saas-1/brands/${name}-light.svg`}
                    width={Number(w)}
                    alt={String(label)}
                  />
                </div>
      ...
      <section className="overflow-hidden py-5 my-md-2 my-xl-4 my-xxl-5">
        <div className="container py-2 py-sm-4 py-lg-5">
          ...
          <div className="row align-items-center position-relative pb-5 pb-lg-0 mb-1 mb-sm-2 mb-md-4 mb-lg-0">
            ...
            >
              <img className="d-dark-mode-none" src="assets/img/landing/saas-2/steps/01-light.png" width="525" alt="Image" />
              <img className="d-none d-dark-mode-block" src="assets/img/landing/saas-2/steps/01-dark.png" width="525" alt="Image" />
            </div>
            ...
            >
              <div className="pe-md-4 pe-lg-0">
                ...
                <p className="pb-1 pb-lg-0 mb-4 mb-lg-5">
                  Nec id eget malesuada urna at sed est adipiscing auctor at massa id duis fames ut condimentum velit est, donec mauris tortor
                  massa et viverra.
                </p>
          ...
          <div className="d-none d-lg-flex justify-content-center" data-aos="fade-in" data-aos-duration="500" data-aos-offset="250">
            <svg
              ...
              style={{ marginLeft: -150, marginTop: -140, marginBottom: -108 }}
            >
              <path
          ...
          <div className="row align-items-center position-relative pb-5 pb-lg-0 mb-1 mb-sm-2 mb-md-4 mb-lg-0">
            <div
              ...
              data-disable-parallax-down="md"
            >
              <img className="d-dark-mode-none" src="assets/img/landing/saas-2/steps/02-light.png" width="473" alt="Image" />
              <img className="d-none d-dark-mode-block" src="assets/img/landing/saas-2/steps/02-dark.png" width="473" alt="Image" />
            </div>
          ...
          <div className="d-none d-lg-flex justify-content-center" data-aos="fade-in" data-aos-duration="500" data-aos-offset="250">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              style={{ marginTop: -60, marginLeft: -120, marginBottom: -80 }}
            >
              <path
          ...
          <div className="row align-items-center position-relative">
            <div
              ...
              data-disable-parallax-down="md"
            >
              <img className="d-dark-mode-none" src="assets/img/landing/saas-2/steps/03-light.png" width="473" alt="Image" />
              <img className="d-none d-dark-mode-block" src="assets/img/landing/saas-2/steps/03-dark.png" width="473" alt="Image" />
            </div>
            ...
            >
              <div className="pe-md-4 pe-lg-0">
                ...
                <p className="pb-1 pb-lg-0 mb-4 mb-lg-5">
                  Bibendum velit mi, ac sed ac malesuada ultrices non lectus mi pellentesque vel at tempus cras sed a eleifend augue amet
                  mauris, leo ac amet erat.
                </p>
                <a className="btn btn-outline-primary rounded-pill" href="#">
                  Get connected
                </a>
      ...
      <section className="bg-dark position-relative overflow-hidden py-5">
        ...
        ></div>
        <div className="container position-relative z-2 pt-3 pb-sm-3 pt-sm-4 py-md-5 my-lg-2 my-xl-3 my-xxl-4" data-bs-theme="dark">
          <div className="row align-items-center py-xxl-2" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
            <div className="col-md-6 pb-3 pb-md-0 mb-3 mb-md-0">
            ...
            <div className="col-md-6 col-lg-5 col-xxl-4 offset-lg-1" data-aos="fade-up" data-aos-duration="850" data-aos-offset="200" data-disable-parallax-down="md">
              <div className="ps-md-4 ps-lg-0">
                <h2 className="mb-lg-4">Acquiring Malta Passport by Fund Investing</h2>
                <p className="text-body pb-lg-2 mb-xl-4">
                  ...
                  product. Bibendum velit mi, ac sed ac malesuada ultrices non lectus mi pellentesque vel at tempus cras sed a eleifend augue
                  amet mauris, leo ac amet erat malesuada ultrices.
                </p>
                <a className="btn btn-lg btn-link px-0" href="#">
                  Learn more <i className="ai-arrow-right ms-2"></i>
                </a>
              </div>
            </div>
          </div>
      ...
      <section className="container pt-5 mt-lg-2 mt-xl-4 mt-xxl-5">
        <div className="row align-items-center pt-2 pt-sm-4 pt-md-5 mt-xl-2 mt-xxl-3" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
          <div className="col-md-7 offset-xl-1 pb-3 pb-md-0 mb-3 mb-md-0 order-md-2">
            <img className="d-dark-mode-none" src="assets/img/about/product/features/02-light.png" width="744" alt="Image" />
            <img className="d-none d-dark-mode-block" src="assets/img/about/product/features/02-dark.png" width="744" alt="Image" />
          </div>
          <div className="col-md-5 col-xl-4 order-md-1" data-aos="fade-up" data-aos-duration="850" data-aos-offset="200" data-disable-parallax-down="md">
            ...
            <div className="row row-cols-2">
              <div className="col">
                <div className="d-table bg-info text-white rounded-1 p-2 mb-3">
                  <i className="ai-time fs-3 m-1"></i>
                </div>
              ...
              <div className="col">
                <div className="d-table bg-danger text-white rounded-1 p-2 mb-3">
                  <i className="ai-cloud-download fs-3 m-1"></i>
                </div>
      ...
      <section className="container pt-5 mt-lg-2 mt-xl-4 mt-xxl-5">
        <div className="row align-items-center pt-2 pt-sm-4 pt-md-5 mt-xl-2 mt-xxl-3" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
          <div className="col-md-6 col-lg-5 pb-3 pb-md-0 mb-3 mb-md-0">
            <img src="assets/img/about/product/features/03.png" width="526" alt="Image" />
          </div>
          <div className="col-md-6 col-lg-5 col-xxl-4 offset-lg-1 offset-xxl-2" data-aos="fade-up" data-aos-duration="850" data-aos-offset="200" data-disable-parallax-down="md">
            <div className="ps-md-4 ps-lg-0">
              <h2 className="mb-lg-4">Make visualization of data analysis results simple and clear way</h2>
              <p className="pb-2 pb-md-3 mb-xl-4">
                Morbi et massa fames ac scelerisque sit commodo dignissim faucibus vel quisque proin lectus laoreet sem adipiscing sollicitudin
                erat massa tellus lorem enim aenean phasellus in hendrerit interdum lorem proin pretium dictum urna suspendisse quis risus et.
              </p>
              <a className="btn btn-lg btn-outline-primary rounded-pill" href="#">
      ...
      <section className="container pt-5 mt-md-3 mt-lg-2 mt-xl-4 mt-xxl-5">
        <h2 className="h1 text-center pt-3 pt-sm-4 pt-lg-5 pb-3 mb-3 mb-lg-4 mt-xl-3">Our benefits</h2>
      ...
      <section className="container overflow-hidden py-5 my-md-3 my-lg-2 my-xl-4 my-xxl-5">
        <div className="row align-items-center my-2 py-2 py-sm-4 py-lg-5 my-xxl-2">
          <div className="col-md-5 text-center text-md-start pe-md-5 pe-lg-0 pe-xxl-4 ps-xl-5 mb-5 mb-md-0">
            <h2 className="h1 pb-3 pb-xl-2 mb-lg-4 mb-xl-5">
              Join Around with your favorite tools that you use daily and keep things on track
            </h2>
            <a className="btn btn-outline-primary rounded-pill" href="#">
          ...
          <div className="col-md-7 col-lg-6 offset-lg-1">
            <div className="position-relative mx-auto" style={{ maxWidth: 510 }}>
              <img
                ...
                src="assets/img/landing/saas-2/tools/circle-gray-1.png"
                style={{ animation: "rotate-cw 100s linear infinite" }}
                alt="Circle"
              />
              <img
                className="d-none d-dark-mode-block"
                src="assets/img/landing/saas-2/tools/circle-light-1.png"
                style={{ animation: "rotate-cw 100s linear infinite" }}
                alt="Circle"
              />
              ...
              <img
                ...
                src="assets/img/landing/saas-2/tools/icon-1.png"
                data-aos="fade"
              ...
              <img
                className="position-absolute top-0 start-0 z-2"
                src="assets/img/landing/saas-2/tools/icon-2.png"
                data-aos="fade"
                data-aos-duration="600"
                data-aos-offset="250"
                data-aos-delay="450"
              ...
              <img
                className="position-absolute top-0 start-0 z-2"
                src="assets/img/landing/saas-2/tools/icon-3.png"
                data-aos="fade"
                data-aos-duration="600"
                data-aos-offset="250"
                data-aos-delay="600"
              ...
              <img
                className="position-absolute top-0 start-0 z-2"
                src="assets/img/landing/saas-2/tools/icon-4.png"
                data-aos="fade"
                data-aos-duration="600"
                data-aos-offset="250"
                data-aos-delay="750"
              ...
              <img
                className="position-absolute top-0 start-0 z-2"
                src="assets/img/landing/saas-2/tools/icon-5.png"
                data-aos="fade"
                data-aos-duration="600"
                data-aos-offset="250"
                data-aos-delay="900"
              ...
              <img
                className="position-absolute top-0 start-0 z-2"
                src="assets/img/landing/saas-2/tools/icon-6.png"
                data-aos="fade"
                data-aos-duration="600"
                data-aos-offset="250"
                data-aos-delay="1050"
              ...
              <img
                className="position-absolute top-0 start-0 z-2"
                src="assets/img/landing/saas-2/tools/icon-7.png"
                data-aos="zoom-in"
                data-aos-duration="600"
                data-aos-offset="250"
                alt="Icon"
              ...
              <img
                className="position-absolute top-0 start-0 z-2"
                src="assets/img/landing/saas-2/tools/icon-8.png"
                data-aos="zoom-in"
                data-aos-duration="600"
                data-aos-offset="250"
                data-aos-delay="150"
              ...
              <img
                className="position-absolute top-0 start-0 z-2"
                src="assets/img/landing/saas-2/tools/icon-9.png"
                data-aos="zoom-in"
                data-aos-duration="600"
                data-aos-offset="250"
                data-aos-delay="300"
      ...
      <section className="pt-2 pt-md-0">
        <div className="position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
          ...
          <div className="container px-4 px-sm-5 px-md-0 position-relative z-2 pt-md-4 pt-lg-5 pb-sm-2 pb-md-3 pb-xl-4 pb-xxl-5" data-bs-theme="dark">
            <div className="row justify-content-center" data-aos="fade-up" data-aos-duration="500" data-aos-offset="300">
              <div className="col-md-10 col-lg-8 col-xl-7 col-xxl-6 text-center py-5">
                ...
                <div className="d-sm-flex justify-content-center">
                  <a className="btn btn-lg btn-warning rounded-pill w-100 w-sm-auto me-sm-4 mb-3 mb-sm-0" href="#">
                    Start free 14-day trial
                  </a>
                  <a className="btn btn-lg btn-outline-warning rounded-pill w-100 w-sm-auto" href="#">
                    Request a demo
                  </a>
                </div>
              </div>
          ...
          <div className="position-relative z-2 px-md-5">
            <img className="d-block d-dark-mode-none mx-auto" src="assets/img/landing/saas-2/dash-light.png" width="1076" alt="Image" />
            <img className="d-none d-dark-mode-block mx-auto" src="assets/img/landing/saas-2/dash-dark.png" width="1076" alt="Image" />
          </div>
        </div>
      </section>
    </main>
